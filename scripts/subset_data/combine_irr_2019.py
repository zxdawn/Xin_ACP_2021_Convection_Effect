...
# lnox_dir = '/WORK/nuist_chenq_2/xin/data/history/NJ/chem/20190725/lfr_lnox_waccm25_aeroff_500lno/'
# savename = f'irr_20190725_lnox_{bottom}-{top}km.nc'

lnox_dir = '/WORK/nuist_chenq_2/xin/data/history/NJ/chem/20190725/ltng_nolnox_waccm25_aeroff/'
savename = f'irr_20190725_nolnox_{bottom}-{top}km.nc'

print(f'Savename {savename}')

irr_lnox = sorted(glob(lnox_dir+'irr/subset/IRR_DIAG_d03_2019-07-25_0[3-6]*'))
...
def conv_da(ds_irr):
    ...
    times = pd.to_datetime(pd.Series([os.path.basename(f) for f in irr_lnox]), format='IRR_DIAG_d03_%Y-%m-%d_%H:%M:%S_subset')[1:]
