...
wrf_dir = '/WORK/nuist_chenq_2/xin/data/history/NJ/chem/20200901/lfr_lnox_era5_3122_qnse_75lev_aeroff/wrfout/'
wrf_file = sorted(glob(wrf_dir+'wrfout_d04_2020-09-01_0[4-6]*'))
savedir = './data/wrfchem/tendency/'
savename = 'tendency_o3_20200901.nc'
