...
def load_china(projection=ccrs.PlateCarree()):
    if platform.system() == 'Windows':
        ...
        source = '../data/shapefiles/cnmap/china_country.shp'
...
def load_simplified_china(projection=ccrs.PlateCarree()):
    if platform.system() == 'Windows':
        ...
        source = '../data/shapefiles/cnmap/simplied_china_country.shp'
...
def load_province(projection=ccrs.PlateCarree()):
    if platform.system() == 'Windows':
        ...
        source = '../data/shapefiles/cnmap/china_province.shp'
...
def load_city(projection=ccrs.PlateCarree()):
    if platform.system() == 'Windows':
        ...
        source = '../data/shapefiles/cnmap/china_city.shp'
...
def load_china_county_level_city(projection=ccrs.PlateCarree()):
    if platform.system() == 'Windows':
        ...
        source = '../data/shapefiles/cnmap/china_county-level_city.shp'
...
def load_china_nine_dotted_line(projection=ccrs.PlateCarree()):
    if platform.system() == 'Windows':
        ...
        source = '../data/shapefiles/cnmap/china_nine_dotted_line.shp'
